...
|----------|--------|--------|---------------------|--------------|
| [Ghost](1%20-%20Ghost/) | [Ghost Path Link](https://breachlab.org/tracks/ghost) | 🟢 Started | 5 | Linux and shell fundamentals. Navigation, permissions, processes, encoding, network, SSH keys, port scanning, cron, git forensics, /proc. Where every operator starts. |
...
| [Sentinel](10%20-%20Sentinel/) | [Sentinel Path Link](https://breachlab.org/tracks/sentinel) | ⚫ Unavailable | 1 | Blue team — the full SOC-to-DFIR arc. Log analysis & SIEM hunting, alert triage, incident response, endpoint & Windows forensics, memory & disk DFIR, malware analysis, network detection, threat hunting, CTI & attribution, detection engineering (Sigma/YARA/Suricata), cloud & identity detection, and detection-driven hardening. A purple-team through-line has you detect the exact TTPs you attacked in Ghost, Phantom, Mirage and Specter. |
| [Prism](11%20-%20Prism/) | [Prism Path Link](https://breachlab.org/tracks/prism) | ⚫ Unavailable | 4 | Apple security. macOS SIP/TCC/Gatekeeper bypass, Keychain extraction, iOS jailbreak fundamentals, app analysis, AirDrop exploitation. |
| [Venom](12%20-%20Venom/) | [Venom Path Link](https://breachlab.org/tracks/venom) | ⚫ Unavailable | 4 | Red team operations. C2 frameworks, implant development, payload delivery, infrastructure setup, EDR bypass, campaign planning, purple teaming. |
| [Flux](13%20-%20Flux/) | [Flux Path Link](https://breachlab.org/tracks/flux) | ⚫ Unavailable | 4 | Binary exploitation and reverse engineering. Stack overflow, ROP, heap, shellcoding, mitigation bypass, malware RE, firmware analysis, exploit development. |
